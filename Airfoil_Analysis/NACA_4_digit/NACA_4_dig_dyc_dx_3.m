% Integrand for C_m_c_4. This is only vaild for 0 < x/c < p/10
...
function dyc_dtheta = NACA_4_dig_dyc_dx_3(theta,m,p)
    C_1 = (m/100)*(20/p);
    C_2 = (m/100)*(200/p^2);
    
    dyc_dtheta = (C_1 - C_2.*0.5.*(1 - cos(theta))).*(cos(2.*theta) - cos(theta));
